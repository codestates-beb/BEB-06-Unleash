...
const MyPageContents = () => {
  ...
  useEffect(() => {
    ...
    setBs2('change');
    axios
      .get(`http://54.180.81.43:5001/user/owned?user_id=${userData.id}`, {
  ...
  const handleClick = e => {
    ...
    if (text === status[1]) {
      ...
      axios
        .get(
          `http://54.180.81.43:5001/user/selling?seller=${userData.wallet_address}`,
          {
            withCredentials: true,
          }
        )
    ...
    if (text === status[2]) {
      ...
      axios.get(`http://54.180.81.43:5001/user/used?seller=${userData.wallet_address}`, {
        withCredentials: true,
      })
      .then(res => {
        const data = res.data;
    ...
    if (text === status[3]) {
      ...
      axios
      .get(
        `http://54.180.81.43:5001/user/selled?seller=${userData.wallet_address}`,
        {
          withCredentials: true,
        }
      )
